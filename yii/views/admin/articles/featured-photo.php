...
<?php $this->beginContent('@app/views/admin/articles/articlesmenu.php', ['active' => 'featured-photo', 'id' => $article->id]); ?>
<?php $this->endContent(); ?>
<div class="spacer-30"></div>
<div class="clearfix"></div>
  ...
  <div class="box-body">
    ...
    FileInput::widget([
        ...
        'pluginOptions' => [
            'uploadUrl' => Url::to(['/Xthehiddenphiloclstadminurlx/articles/upload-featured-photo', 'id' => $article->id]),
            'showPreview' => true,
            'showCaption' => true,
            'showRemove' => false,
            'showUpload' => true
