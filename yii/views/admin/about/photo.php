...
<?php $this->beginContent('@app/views/admin/about/aboutmenu.php', ['active' => 'photo', 'id' => $model->id]); ?>
<?php $this->endContent(); ?>
<div class="spacer-30"></div>
<div class="clearfix"></div>
  ...
  <div class="box-body">
    ...
    FileInput::widget([
        ...
        'pluginOptions' => [
            'uploadUrl' => Url::to(['/Xthehiddenphiloclstadminurlx/about/upload-photo', 'id' => $model->id]),
            'showPreview' => true,
            'showCaption' => true,
            'showRemove' => false,
            'showUpload' => true,
