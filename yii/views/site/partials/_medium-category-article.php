...
<div class="medium-category-article">
    ...
    <a href="<?=Url::base(true)?>/article/<?=$model->slug?>" class="h_340 main-article-box" data-src="<?=Url::base(true)?>/images/articles/<?=$model->photo?>.jpg" style="background-image: url('<?=Url::base(true)?>/images/articles/<?=$model->photo?>.jpg');">
        <div class="overlay">
        </div>
    </a>
    <?php endif;?>
