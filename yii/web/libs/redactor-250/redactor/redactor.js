		...
		image: function()
		{
			return {
				...
				showEdit: function($image)
				{
					...
					$('#redactor-image-preview').html($('<img class="lazyload" src="' + $image.attr('src') + '" style="max-width: 100%;">'));
		...
		linkify: function()
		{
			return {
				...
				convertImages: function(html)
				{
					...
					return html.replace(html, '<img class="lazyload" src="' + matches + '" class="redactor-linkify-object" />');
				},
